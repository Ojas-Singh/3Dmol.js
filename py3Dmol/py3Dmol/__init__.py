...
class view(object):
    ...
    '''
    def __init__(self,query='',width=640,height=480,viewergrid=None,data=None,style=None,linked=True,options=dict(),js='https://cdn.jsdelivr.net/npm/3dmol@1.8.0/build/3Dmol-min.js'):
